...
// h2見出しの共通スタイル（左アクセントバー＋背景色）。ManufacturerGuideArticleBody が
// テンプレート見出しを自前で描画する際もこの定数を再利用し、見た目がズレないようにする。
export const sectionHeadingClassName =
  'scroll-mt-site-header mt-8 mb-4 border-l-4 border-primary bg-muted/60 py-2 pl-3 pr-3 text-lg font-semibold text-foreground';

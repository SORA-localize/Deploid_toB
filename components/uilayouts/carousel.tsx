...
interface CarouselContextProps {
  ...
  emblaThumbsRef: (node: HTMLElement | null) => void;
...
// ============= SLIDER CONTAINER =============
export const SliderContainer = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
...
// ============= PROGRESS BAR =============
export const SliderProgress = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => {
...
interface CarouselIndicatorProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  index: number;
}
...
interface ThumbsSliderProps extends HTMLAttributes<HTMLDivElement> {

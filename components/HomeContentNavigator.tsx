  ...
  return (
    <section className="border-b border-border py-8 sm:py-12">
      ...
      <div className="hidden lg:grid gap-6 lg:grid-cols-[minmax(0,0.85fr)_minmax(420px,1.15fr)] lg:items-stretch">
        ...
        <div className="hidden lg:block relative min-h-[440px] overflow-hidden bg-neutral-950 text-white 2xl:min-h-[520px] 2xl:max-h-[600px]">
          ...
          <div className="pointer-events-none relative z-10 flex min-h-[440px] flex-col justify-between p-6 lg:p-8 2xl:min-h-[520px]">
            <AnimatePresence mode="wait">
              <motion.div

import { getManufacturerBySlug, getManufacturers } from '@/lib/data';
...
export default async function ManufacturerDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="mx-auto max-w-7xl px-6 py-12">
      <h1 className="text-2xl font-semibold text-foreground">{manufacturer.nameJa ?? manufacturer.name}</h1>

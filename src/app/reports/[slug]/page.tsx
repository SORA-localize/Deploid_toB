    ...
    <div className="min-h-screen bg-neutral-100">
      <div className="border-b border-neutral-300 bg-white">
        <div className="mx-auto max-w-7xl px-6 py-6">
          ...
          <p className="text-sm text-neutral-700 leading-relaxed max-w-3xl mb-5">{report.summary}</p>
          <div className="flex items-center gap-5 text-xs text-neutral-600 pb-5 border-b border-neutral-200 flex-wrap">

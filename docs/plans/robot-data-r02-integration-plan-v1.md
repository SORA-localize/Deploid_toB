...
Implementation review rule: `docs/decisions/ai_fullstack_development_guardrails_v1.md`
...
- `docs/decisions/data/research/DATA-R02-*` の監査・固定
- `docs/decisions/data/README.md` のR02案内追加
- 必要なRobotデータ契約
...
- 調査履歴: `docs/decisions/data/research/DATA-R02-*`。公開データの正本にはしない
...
- `docs/decisions/data/research/DATA-R02-*`
...
- `docs/decisions/data/README.md`へR02の役割と「dataへ直接コピーしない」注意を追加
...
```bash
jq -e . docs/decisions/data/research/DATA-R02-*.json
...
- `docs/decisions/data/research/DATA-R02-decisions.md`（new）
...
- `docs/decisions/data/research/DATA-R02-IMPLEMENT-*.json`（new）
- `docs/decisions/data/research/DATA-R02-implementation-report.md`（new）
...
`R02-04`はOption A（現行モデル維持、新フィールド追加なし）で承認済み（`docs/decisions/data/research/DATA-R02-decisions.md` §8a）。R02-05/06（schema・UI拡張）は実施しない。

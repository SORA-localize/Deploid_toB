...
> 書き方・文体・分量は `editorial_style_guide_v1.md`、題材選定の判断軸は `../plans/editorial-methodology-review-2026-06-24.md`（承認後は統合）を参照。
...
**例外**：論文・研究発表が商用導入、安全規制、製品仕様、PoC設計に直接つながり、かつ信頼できる二次報道で裏取りできる場合のみ、`../plans/editorial-methodology-review-2026-06-24.md` §5 の例外規定に従って候補にしてよい。単独の論文紹介は不可。

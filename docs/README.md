...
**セッションを引き継ぐ場合**は [`reference/session-handoff-2026-09-07.md`](reference/session-handoff-2026-09-07.md) を先に読むと、直近の完了事項・未完了事項・要注意点がまとまっている（スナップショットなので、新しい引き継ぎメモが増えたらそちらを優先する）。
...
| [Admin編集画面レイアウト整理のロールアウト](plans/admin-layout-rollout-plan-v1.md) | Manufacturersのみtabs/sidebar化済み（Task 6 POC）。残り8 collection/globalへの展開＋配列fieldの追加ボタン日本語化を計画化。**未着手** | 専用branchなし（未定） | 2026-09-07 |

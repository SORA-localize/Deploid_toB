...
export const robots: Robot[] = [
  ...
  },
  {
    ...
    summary: 'BMW Spartanburg での11ヶ月実証を完了。Figure AI は後継ロボット Figure 03 へ移行中。',
    publishStatus: 'published',
    ...
    images: {
      ...
      endEffector: {
        src: 'https://images.ctfassets.net/qx5k8y1u9drj/3xwct2ksCay3D0tDAaqc2S/1ba1e10a09631123e5ac2847b2388204/hands.png',
    ...
    comparison: {
      ...
      constraints: ['一般販売条件が確認できない', '日本での導入窓口が確認できない', '世代交代により後継ロボットへ移行中'],
  ...
  },
  {
    ...
    images: {
      hero: {
        ...
        alt: 'Sanctuary AI Phoenix Gen 8',
        credit: 'Sanctuary AI',
  ...
  },
  {
    ...
    description:
      'NEURA Robotics が開発する産業向けフルサイズ・ヒューマノイド. 電気アクチュエータ＋360°3Dビジョン＋人工皮膚センサを組み合わせ、全関節にフォース・トルクセンサを搭載。ホットスワップ対応 of デュアルバッテリーで長時間連続稼働を想定。2026後半の出荷開始に向けてデポジット予約受付中。日本では日栄機工株式会社が唯一の正規代理店として問い合わせを担当。国内導入を検討する場合は、日栄機工経由で技術要件・価格・保守条件を確認することが起点となる。',
    deploymentStage: 'pilot',
    buyerReadiness: 'limited-today',
    specs: {
      heightCm: 180,
    ...
    supportNote: '国内代理店経由でのサポート体制を確認する. 欧州本社との連携サポートになるため、対応範囲・リードタイムを事前に合意する。',
    safetyNote: '産業環境への導入にあたっては安全規格（ISO 10218等）への適合確認が必要。',
    vendorRiskNote: '2026後半出荷予定のため現時点では実機未納品. 量産・保守体制の成熟度は出荷開始後に要確認。',
    industryTags: ['manufacturing', 'logistics'],
    taskTags: ['assembly', 'material-handling'],
    comparison: {
  ...
  },
  {
    ...
    vendorRiskNote: '量産実績・資金調達は堅調. Huawei 依存のエコシステムおよび国際展開の成熟度は要確認。',
    industryTags: ['research', 'education'],
    taskTags: ['r-and-d'],
    comparison: {
  ...
  },
  {
    ...
    description:
      'Unitree が2026年に量産を開始した小型二足ヒューマノイド. エントリーモデルの R1 Air（$4,900・20DOF）と標準の R1（$5,900・26DOF）の2バリアントがある。Air は腰・頭の自由度とデプスカメラを省いた軽量版（25kg）。研究・教育・エンターテインメント・スポーツデモを主な用途として設計されており、宙返り・側転などの動的モーションに特化している。産業ペイロード用途には設計されていな い。日本では TechShare株式会社が代理店として対応する。',
    deploymentStage: 'production',
    ...
    vendorRiskNote: '親会社 Unitree は四足・ヒューマノイドで量産実績あり. R1 は新ロボットのため長期サポート体制は要確認。',
  ...
  },
  {
    ...
    category: 'humanoid',
    summary: 'LimX Dynamics の量産型ヒューマノイド. 高い運動性能と $21,800 の価格訴求が特徴。',
    publishStatus: 'draft',
    updatedAt: '2026-06-02',
    reliability: 'official',
    sources: [
      {
        title: 'LimX Dynamics Oli product page',
    ...
    description: '四足歩行・二足歩行の両方で培った高い運動制御技術を搭載. 2025年に量産型 Oli ($21,800) を発表。18台同時稼働デモなど、スケーラビリティを証明。',
    specs: {
      heightCm: 165,
      weightKg: 55,
      mobility: 'biped',
    ...
    japanAvailability: 'unknown',
    comparison: {
      strengths: ['高い運動性能', 'コストパフォーマンス', '最新の制御アルゴリズム'],
      constraints: ['日本国内サポート未整備', '本番運用実績はこれから'],
      bestFit: ['研究開発', '運動制御の検証', '低コストなPoC'],
      notFit: ['即時の産業投入', '国内保守が必須の案件'],
    },
  },
  {
    slug: 'limx-luna',
    ...
    manufacturerSlug: 'limx-dynamics',
    category: 'humanoid',
    summary: 'LimX Dynamics の対話・家庭向けヒューマノイド. 親しみやすい外観と最新 AI を統合。',
    publishStatus: 'draft',
    updatedAt: '2026-06-02',
    reliability: 'official',
    sources: [
      {
        title: 'LimX Dynamics Luna product page',
        url: 'https://www.limxdynamics.com/',
        publisher: 'LimX Dynamics',
        checkedAt: '2026-06-02',
        reliability: 'official',
    ...
    description: '家庭内での対話や軽作業を想定したモデル. Oli 譲りの運動性能と、マルチモーダル AI を組み合わせた HRI（Human-Robot Interaction）に重点を置く。',
    specs: {
      heightCm: 160,
      weightKg: 48,
      mobility: 'biped',
    ...
    japanAvailability: 'unknown',
    comparison: {
      strengths: ['対話・HRI への特化', '軽量・親しみやすいデザイン', '最新 AI モデルとの親和性'],
      constraints: ['産業タスクには不向き', '量産前段階'],
      bestFit: ['HRI 研究', '受付・案内デモの検証', '家庭用ロボットの先行開発'],
      notFit: ['重量物搬送', '産業ライン'],
    },
  },
  {
    ...
    category: 'humanoid',
    summary: 'XPENG が自社工場導入・量産を視野に開発するヒューマノイド. Turing AI チップ搭載。',
    publishStatus: 'draft',
    updatedAt: '2026-06-02',
    reliability: 'official',
    sources: [
      {
        title: 'XPENG Iron AI Day 2024 Press Kit',
    ...
    description: 'XPENG 傘下のロボティクス部門が開発. 自社製AIチップ「Turing」を搭載。EV製造の知見を活かした量産設計が強み。すでに自社生産ラインでの補助タスクに従事。',
    specs: {
      heightCm: 173,
      weightKg: 70,
      mobility: 'biped',
    ...
    japanAvailability: 'unavailable',
    comparison: {
      strengths: ['EV製造の量産・品質管理資産', '自社製 Turing AI チップによる高度な推論', '自社工場での実働実績'],
      constraints: ['外部販売は2026年末以降の見込み', '日本展開計画は未確認'],
      bestFit: ['製造ライン向け汎用ロボットのベンチマーク', '将来の量産コスト基準の参照'],
      notFit: ['即時導入', '日本国内での近期調達'],
    },
  },
];

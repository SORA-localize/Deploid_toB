...
Pudu Roboticsはこれまで配膳ロボット・清掃ロボットといったサービス業向け機体で実績を積んできた企業で、ヒューマノイド専業メーカーとして立ち上がった企業ではない。この経緯は、D7の設計判断にも表れている。研究開発段階の二足歩行機を一から作るのではなく、既存の自律移動・センシング技術を産業用途向けに転用し、ペイロードと稼働時間を伸ばす方向に振っている。Robot.comのR-noidが配達ロボット事業の運用知見を職場向けロボットに転用した事例と同様、ヒューマノイド市場では「既存ロボット事業の隣接領域への展開」が、ゼロから二足歩行機を開発するより速い立ち上がりの手段になりつつある。導入企業にとっては、メーカーの出自が配膳・清掃・配送のどこにあるかを見ることで、得意とする現場条件（屋内平坦面か、屋外段差ありか）をある程度推測できる。`,
...

  {
    ...
    titleJa: 'メーカー解説シリーズ vol.1｜Unitree Roboticsをどう見るか？ 価格・実績・日本での調達',
    type: 'manufacturer-guide',
    category: 'company-report',
    section: 'business',
    summary:
      'Unitree Roboticsを、研究・教育・初期PoCの調達候補としてどう評価すべきか。価格、供給力、商用実績、日本の窓口を分けて整理する。',
    publishStatus: 'published',
    ...
    sources: [
      ...
      },
      {
        ...
        checkedAt: '2026-07-12',
        reliability: 'reported',
        note: 'IPO目論見書ベースの売上・出荷・粗利率・価格推移の根拠。',
      },
      {
        ...
        checkedAt: '2026-07-12',
        reliability: 'reported',
        note: '中国における教育・研究用途の入札、業務適用に向けた開発案件の根拠。',
      },
      {
    ...
    manufacturerGuideContent: {
      companyOverview:
        'Unitreeは、中国・杭州に本社を置くロボットメーカーで、四足歩行ロボットの量産で成長し、低価格帯ヒューマノイドでも存在感を高めている。人型ロボットではR1、G1、H1、H2シリーズをラインアップするほか、四足歩行ロボットも主力製品として販売している。\n\nモーターや減速機など、ロボット向け部品も自社で開発・製造している。UnitreeのIPO関連資料と、それを基にした報道では、2025年の売上高は16.99億元、四足歩行ロボットの出荷は1万8,000台超、ヒューマノイドの出荷は約5,500台とされる。公開情報では、ヒューマノイドは研究、教育、開発、展示での利用が目立つ。',
      history:
        'Unitreeは2016年の設立後、Goシリーズなどの四足歩行ロボットを展開した。その後、H1、G1、R1と人型機を加え、フルサイズ機から小型・低価格機まで扱うようになった。\n\n2026年には中国で上場準備が進む一方、米国防総省は6月にUnitreeを1260Hリストへ追加した。この指定は日本の民生調達を直接禁止するものではない。',
      productLineup:
        'R1系は小型・低価格帯、G1系は研究・開発向け、H1・H2系はフルサイズ機に位置付けられる。H2 PlusはNVIDIAとの協業で発表されたAI開発プラットフォームで、H2とは構成と価格帯が異なる。\n\nR1 AIRの公式価格は$4,900〜、G1は$13,500〜、H2は$29,900〜。以下の価格は本体の目安で、税・送料・国内保守費用は含まない。',
      lineup: [
      ...
      evaluationIntro:
        '以下は公開情報を基にしたDeploidの分析である。Unitreeの位置付けは、価格、商用実績、日本での調達条件の3点から整理できる。',
      evaluationAxes: {
        pricing: {
          level: 'strength',
          body: 'R1、G1、H2は公式価格が公開されており、競合と比べても初期導入コストを把握しやすい。研究・PoC用途では予算を立てやすい点が強みとなる。国内での総額は輸送、関税、保守、開発支援で変わる。',
        },
        productionCapacity: {
          level: 'strength',
          body: '出荷規模を見る限り、Unitreeは量産体制を構築しているメーカーと評価できる。一方、個別構成の納期、交換部品、国内修理の所要時間は公開されていない。',
        },
        ecosystem: {
          level: 'strength',
          body: '研究・教育用途での導入が多く、開発コミュニティも比較的充実している。H2 PlusではNVIDIAとの協業も発表されており、AI開発向けの取り組みも進む。自社でロボットを動かし、データを集める組織には入りやすい。',
        },
        trackRecord: {
          level: 'caution',
          body: '公開情報で確認できる利用は、研究・教育、展示、社内実証が中心である。量産・価格の強さは、第三者の業務現場で長期に稼働した実績とは別に扱う必要がある。',
        },
        geopoliticalRisk: {
          level: 'risk',
          body: '2026年6月、米国防総省の1260HリストにUnitreeが追加された。日本の民生調達を直接禁止する指定ではないが、米国の取引先・投資家・海外拠点を持つ組織では、調達前に影響範囲を確認したい。',
        },
      },
      deploymentIntro:
        '公開情報で確認できる利用を、商用、PoC、研究・教育、展示、社内実証に分けた。',
      deploymentStatus: {
        commercial: {
          evidence: 'none',
          body: '第三者企業の現場で長期運用されていることを裏付ける公開事例は確認できない。',
        },
        poc: {
          evidence: 'limited',
          body: '変電所点検や消防偵察など、業務適用を目指す開発案件が報じられている。',
        },
        researchEducation: {
          evidence: 'confirmed',
          body: '中国の大学・研究機関での調達、海外研究機関への供給が確認されている。',
        },
        exhibitionDemo: {
          evidence: 'confirmed',
          body: 'R1、G1、H1はイベントや展示での実演が確認されている。',
        },
        internalTrial: {
          evidence: 'confirmed',
          labelOverride: 'あり（自社発表のみ）',
          body: 'Unitreeは自社工場でG1が部品を組み立てる映像を公開している。稼働率や生産性は公表されていない。',
        },
      },
      deploymentOutro:
        '研究・教育・展示・社内実証の情報は確認できる。一方、第三者の業務現場での長期運用に関する公開情報は限られる。',
      japanProcurement:
        '日本の窓口として、TechShare、Tohasen Robotics、GMO AI&ロボティクス商事（GMO AIR）が確認できる。TechShareとTohasen Roboticsは人型機を取り扱う。GMO AIRは販売に加え、導入支援、ソフトウェア開発、保守運用を掲げる。\n\n対象機種、販売条件、国内修理の可否、保守範囲は窓口ごとに異なる。送料・関税・消費税、初期設定、交換部品、保証、修理の送り先、ソフトウェア更新の担当は、見積もり時に確認したい項目である。',
      faq: [
        {
          question: 'Unitreeのヒューマノイドは日本で購入できますか？',
          answer: '国内の取扱窓口を通じて相談できる。TechShare、Tohasen Robotics、GMO AI&ロボティクス商事では、取扱機種と支援範囲が異なる。',
        },
        {
          question: '価格はいくらからですか？',
          answer: 'Unitree公式の表示ではR1 AIRが$4,900〜、G1が$13,500〜、H2が$29,900〜である。税・送料は別で、日本での総額は構成、輸送、保守、開発支援によって変わる。',
        },
        {
          question: '商用の現場ですぐ使えますか？',
          answer: '研究・教育・展示の利用は確認できる。一方、第三者の現場で業務を長期運用した公開実績は限られる。',
        },
        {
          question: '1260Hリスト入りは日本企業の購入を禁止しますか？',
          answer: '米国防総省の1260Hリストは、日本企業の民生調達を直接禁止するものではない。ただし、米国の取引先・投資家・海外拠点との関係によっては確認が必要になる。自社の取引条件に照らして、調達窓口や法務へ確認したい。',
        },
      ],
      fitSummary:
        'Unitreeは、実機を使ってヒューマノイドの開発や検証を進める組織に向く。大学・高専・研究機関、ロボティクスを内製するR&D部門、SIer、ロボット開発企業、展示や教育で機体を使う組織では、R1やG1が候補になる。\n\n本番業務をすぐ任せる用途では、作業の再現性、停止時の復旧、保守SLA、安全責任、交換部品の納期が判断材料になる。公開情報だけでは確認できない項目が多い。商用現場での実績を重視する場合はAgility Robotics、製造現場での導入を重視する場合はUBTECHなども比較対象となる。価格だけでなく、導入実績や国内サポート体制も含めて比較したい。',
    },
  },
  {
    ...
    titleJa: 'メーカー解説シリーズ vol.2｜Agility Roboticsとは？ Digitの導入実績・価格・日本での相談方法',
    type: 'manufacturer-guide',
    category: 'company-report',
    section: 'business',
    summary:

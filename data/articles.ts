...
Pudu Roboticsはこれまで配膳ロボット・清掃ロボットといったサービス業向け機体で実績を積んできた企業で、ヒューマノイド専業メーカーとして立ち上がった企業ではない。この経緯は、D7の設計判断にも表れている。研究開発段階の二足歩行機を一から作るのではなく、既存の自律移動・センシング技術を産業用途向けに転用し、ペイロードと稼働時間を伸ばす方向に振っている。Robot.comのR-noidが配達ロボット事業の運用知見を職場向けロボットに転用した事例と同様、ヒューマノイド市場では「既存ロボット事業の隣接領域への展開」が、ゼロから二足歩行機を開発するより速い立ち上がりの手段になりつつある。導入企業にとっては、メーカーの出自が配膳・清掃・配送のどこにあるかを見ることで、得意とする現場条件（屋内平坦面か、屋外段差ありか）をある程度推測できる。`,
...

  {
    ...
    manufacturerGuideContent: {
      companyOverview:
        'Unitreeは、中国・杭州に本社を置くロボットメーカーで、四足歩行ロボットの量産で成長し、低価格帯ヒューマノイドでも存在感を高めている。人型ロボットではR1、G1、H1、H2シリーズをラインアップするほか、四足歩行ロボットも主力製品として販売している。\n\nモーターや減速機など、ロボット向け部品も自社で開発・製造している。UnitreeのIPO関連資料と、それを基にした報道では、2025年の売上高は16.99億元、四足歩行ロボットの出荷は1万8,000台超、ヒューマノイドの出荷は約5,500台とされる。人型ロボットは研究、教育、開発、展示で使われている。',
      history:
        'Unitreeは2016年の設立後、Goシリーズなどの四足歩行ロボットを展開した。四足機の量産で培った製造・部品供給の基盤をもとに、H1、G1、R1と人型機を追加し、フルサイズ機から小型・低価格機まで製品群を広げている。',
      productLineup:
      ...
      deploymentStatus: {
        commercial: {
          evidence: 'none',
          labelOverride: '公開事例なし',
          body: '第三者企業の現場で長期運用された公開事例はない。',
        },
        poc: {
          evidence: 'limited',
          labelOverride: '開発案件の報道あり',
          body: '変電所点検や消防偵察など、業務適用を目指す開発案件が報じられている。',
        },
        researchEducation: {
          evidence: 'confirmed',
          labelOverride: '導入確認',
          body: '中国の大学・研究機関での調達、海外研究機関への供給がある。',
        },
        exhibitionDemo: {
          evidence: 'confirmed',
          labelOverride: '実演確認',
          body: 'R1、G1、H1はイベントや展示で実演されている。',
        },
        internalTrial: {
          evidence: 'confirmed',
          labelOverride: '自社発表あり',
      ...
      japanProcurement:
        '日本ではTechShare、Tohasen Robotics、GMO AI&ロボティクス商事（GMO AIR）が窓口となる。TechShareとTohasen Roboticsは人型機を取り扱い、GMO AIRは販売に加え、導入支援、ソフトウェア開発、保守運用を掲げる。\n\n対象機種、販売条件、国内修理の可否、保守範囲は窓口ごとに異なる。本体価格のほか、送料・関税・消費税、初期設定、交換部品、保証、修理の送り先、ソフトウェア更新の担当を見積もりに含める。',
      faq: [],
      fitSummary:
        'Unitreeは、実機を使ってヒューマノイドの開発や検証を進める組織に向く。大学・高専・研究機関、ロボティクスを内製するR&D部門、SIer、ロボット開発企業、展示や教育で機体を使う組織では、R1やG1が候補になる。\n\n本番業務をすぐ任せる用途では、作業の再現性、停止時の復旧、保守SLA、安全責任、交換部品の納期が論点になる。比較では、価格、導入実績、国内サポート体制を分けて見る。商用現場での実績を重視する場合はAgility Robotics、製造現場での導入を重視する場合はUBTECHなどが比較対象になる。',
    },
  },
  {

...
Pudu Roboticsはこれまで配膳ロボット・清掃ロボットといったサービス業向け機体で実績を積んできた企業で、ヒューマノイド専業メーカーとして立ち上がった企業ではない。この経緯は、D7の設計判断にも表れている。研究開発段階の二足歩行機を一から作るのではなく、既存の自律移動・センシング技術を産業用途向けに転用し、ペイロードと稼働時間を伸ばす方向に振っている。Robot.comのR-noidが配達ロボット事業の運用知見を職場向けロボットに転用した事例と同様、ヒューマノイド市場では「既存ロボット事業の隣接領域への展開」が、ゼロから二足歩行機を開発するより速い立ち上がりの手段になりつつある。導入企業にとっては、メーカーの出自が配膳・清掃・配送のどこにあるかを見ることで、得意とする現場条件（屋内平坦面か、屋外段差ありか）をある程度推測できる。`,
  ...
  },
  {
    ...
    title: 'Unitree Robotics: company profile and buyer\'s guide',
    titleJa: 'Unitreeとは——価格で先行する中国ヒューマノイドメーカーの実力と注意点',
    type: 'manufacturer-guide',
    category: 'company-report',
    section: 'business',
    summary:
      'Unitree Roboticsの会社概要・沿革・製品ラインナップ・強みと注意点・導入実績・日本からの調達導線を整理する。',
    publishStatus: 'published',
    ...
    relatedUseCaseIds: [],
    whyItMatters:
      'Unitreeは価格と量産力で頭ひとつ抜けたヒューマノイドメーカーだが、商用導入の第三者検証実績はまだ薄い。2026年6月に米国防総省の1260Hリストに追加された事実も含め、価格だけでなく調達リスクを合わせて評価すべき相手である。',
    sources: [
      {
      ...
      },
      {
        ...
        checkedAt: '2026-07-01',
        reliability: 'reported',
        note: '2025年通期の確定値は「Unitree Robotics clears China STAR Market listing review」（id: unitree-ipo-star-market-june2026）がIPO目論見書ベースで報じている。本記事の financial 数値はそちらと揃えた。',
      },
      {
      ...
      },
      {
        ...
        checkedAt: '2026-07-01',
        reliability: 'official',
        note: '1260Hリストの一次情報。Unitreeが追加対象に含まれることを確認。',
      },
      {
        ...
        checkedAt: '2026-07-03',
        reliability: 'official',
        note: 'R1 AIR $4,900・R1 $5,900（税・送料別）の価格根拠。',
      },
      {
        ...
        checkedAt: '2026-07-03',
        reliability: 'official',
        note: 'TechShareがUnitree国内正規代理店としてG1を販売していることの根拠。',
      },
      {
        ...
        checkedAt: '2026-07-03',
        reliability: 'official',
        note: 'Tohasen RoboticsがUnitreeヒューマノイド（G1・H2等）を取り扱うことの根拠。',
      },
      {
        ...
        checkedAt: '2026-07-03',
        reliability: 'reported',
        note: 'GMO AI&ロボティクス商事が2026-06-19に正規代理店契約を締結した根拠。',
      },
      {
        ...
        checkedAt: '2026-07-03',
        reliability: 'reported',
        note: 'IPO目論見書ベースの分析。セグメント別粗利率（四足55.5%・人型62.9%・部品60.4%）、2025年出荷台数（四足1.8万台超・人型5,500台、人型は生産3,700台/販売3,551台）、人型平均販売価格の前年比-35.7%、管理費比率4.2%の根拠。',
      },
      {
        ...
        checkedAt: '2026-07-03',
        reliability: 'reported',
        note: '中国国内の教育・研究入札92件（前年比2.4倍）、同済大学の10台825万元調達、変電所点検・消防偵察の開発需要、UBTECHとの戦略差、レンタル市場活況の根拠。',
      },
    ],
    manufacturerGuideContent: {
      companyOverview:
        'Unitreeは杭州に本社を置く中国のロボットメーカーである。事業は四足歩行ロボット・ヒューマノイド・ロボット部品の3本柱で、2025年通期の売上高は16.99億元（約2.5億ドル）、IPO目論見書ベースの分析ではどのセグメントも粗利率55〜63%という高い利益体質を持つ。ヒューマノイドは2025年に約5,500台を出荷しており、台数ベースでは世界最大級の人型ロボットメーカーになっている。\n\nヒューマノイド専業のスタートアップと違い、先に四足ロボットで量産と収益化を完成させてから人型に参入した「量産技術で人型を安くする会社」であり、主戦場は研究機関・教育機関・開発者市場である。商用の現場での本番運用実績はまだ検証途上で、日本からは代理店経由での調達が現実的な選択肢になる。',
      history:
        '2016年、大学院時代に四足ロボットを研究していた王興興氏がUnitreeを設立した。以降数年は四足歩行ロボットの専業企業として、量産型モデルを継続的に投入する時期にあたる。\n\nGo1などのモデルが低価格帯で市場に広がったことで、「量産と低価格化を両立できる会社」というイメージを固めた。イベント出演や教育現場への導入が進み、四足ロボットの代表格として認知される。この時期に築いた量産体制とサプライチェーンが、のちに四足で年間1万8,000台超という出荷規模と、人型参入の土台になる。\n\nその後、H1を皮切りに事業の軸足を人型ロボットにも広げ、G1・R1と価格帯の異なるヒューマノイドを揃えていった。四足で確立した量産・供給の型をそのまま人型に横展開し、参入からわずか数年でヒューマノイド年間約5,500台の出荷規模に達している。売上も2022〜2024年の年1〜3億元から2025年には16.99億元へ急拡大しており、会社の性格が「四足の会社」から「人型を量産できる会社」へ変わった時期といえる。\n\n直近では、量産実績を背景に資金調達・上場準備が進み、2026年6月1日には上海証券取引所STARマーケットの上場審査を通過した。IPO目論見書によるとコア事業粗利益率は60.13%で、調達目標は42億元（約6.2億ドル）、上場後の想定評価額は420億元（約62億ドル）とされる。同時に、米国の安全保障政策の対象としても名前が挙がるようになり、事業の評価軸に地政学リスクが加わり始めている。',
      productLineup:
        '現行ラインナップは、用途で4つに束ねると分かりやすい。「まず触れてみたい」層に向くエントリーのR1系、研究・教育・PoCの標準候補となるG1系、フルサイズで運動性能や産業用途の検証を重視するH1・H2系、そしてNVIDIA・Sharpaとの協業で2026年に発表された、単体のロボットというよりAI開発プラットフォームであるH2 Plusだ。\n\n注目すべきは価格の動かし方である。IPO目論見書ベースの分析では、ヒューマノイドの平均販売価格を1年で35.7%下げながら、人型セグメントの粗利率は62.9%を保っている。モーター等の部品を内部に持ち外販までする部品事業（粗利率60.4%）と、業界平均の約6分の1という管理費比率がこの構造を支えており、低価格は一時的な安売りではなく、価格で市場を先に取りにいく恒常的な戦略と読める。\n\n主な構成と価格の目安は下表のとおり（価格はUnitree公式の表示、税・送料別、2026年6〜7月時点）。詳細な自由度・荷重・稼働時間は各機体のロボット詳細ページで確認できる。',
      lineup: [
        { robotId: 'unitree-r1', roleLabel: '低価格エントリー。教育・実験・展示向け', priceLabel: '$4,900〜' },
        { robotId: 'unitree-r1-standard', roleLabel: 'R1シリーズの上位構成', priceLabel: '$5,900〜' },
        { robotId: 'unitree-g1', roleLabel: '研究・教育・PoCの標準候補', priceLabel: '$13,500〜' },
        { robotId: 'unitree-g1-edu', roleLabel: '二次開発向け構成（自由度を拡張可能）', priceLabel: '要見積' },
        { robotId: 'unitree-h1', roleLabel: 'フルサイズの運動性能検証機', priceLabel: '要問い合わせ' },
        { robotId: 'unitree-h2', roleLabel: 'フルサイズの現行主力', priceLabel: '$29,900〜' },
        { robotId: 'unitree-h2-plus', roleLabel: 'NVIDIA協業のAI開発プラットフォーム', priceLabel: '$100,000' },
      ],
      videos: [
        {
          platform: 'youtube',
          videoId: 'GzX1qOIO1bE',
          title: 'Unitree Introducing | Unitree G1 Humanoid Agent | AI Avatar | Price from $16K',
          channelName: 'Unitree Robotics',
          channelUrl: 'https://www.youtube.com/@unitreerobotics',
        },
      ],
      evaluationIntro: '評価は5つの軸に分けて読むのが実務的である。各軸とも、確認済みの事実と未確認の留意点を分けて示す。',
      evaluationAxes: {
        pricing: {
          level: 'strength',
          body: 'G1・R1は同クラスのヒューマノイドの数分の1の価格帯にあり、しかも一時的な安売りではない。IPO目論見書ベースの分析では、人型の平均販売価格を1年で35.7%下げながら人型セグメントの粗利率62.9%を維持しており、部品まで内部に持つコスト構造と業界平均の約6分の1という管理費比率が「下げても儲かる」価格設定を支えている。予算が限られる検証初期の候補として頭ひとつ抜けた水準である。',
        },
        productionCapacity: {
          level: 'strength',
          body: '2025年に四足1万8,000台超・ヒューマノイド約5,500台を出荷し、人型は生産分をほぼ売り切っている（生産3,700台に対し販売3,551台）。「注文しても作れないのでは」という供給側の不安が小さいことは、ヒューマノイド専業スタートアップに対する明確な優位である。ただしこれは供給力の話であり、機体が第三者の現場で長期稼働した実績とは別の論点である。',
        },
        ecosystem: {
          level: 'strength',
          body: 'NVIDIAが自社のリファレンス基盤の土台としてH2ボディを採用するなど、開発者向けエコシステムとの接続は強い。モーター等の部品を外販する部品事業も持ち、研究・開発コミュニティでの存在感は機体の販売台数以上に大きい。ただしこれは開発基盤としての評価であり、現場でそのまま使える運用実績を意味しない。',
        },
        trackRecord: {
          level: 'caution',
          body: '第三者企業が本番稼働として検証した事例は、公開情報の範囲では確認できない。中国国内では2025年の教育・研究用途の入札が92件と前年の2.4倍に増え、同済大学が10台を825万元で調達するなど導入自体は広がっているが、中心はあくまで研究開発・教育であり、業務の現場を置き換える種類の実績ではない。話題になった自社工場での組立実証も、Unitreeが自ら公開した動画のみが根拠である。',
        },
        geopoliticalRisk: {
          level: 'risk',
          body: '2026年6月、米国防総省がUnitreeを中国軍民融合に関与する企業として「1260Hリスト」に追加した。日本企業の民生調達を法的に禁止するものではないが、米国の輸出管理・調達方針の変化を注視する材料になる。加えて創業者主導の経営体制であるため、上場後に情報開示とガバナンスがどう整っていくかも中長期の確認点になる。',
        },
      },
      deploymentIntro:
        '公開情報で確認できるUnitreeの使われ方は、研究・教育と自社実証に厚く、商用導入・PoCは薄い。次の5分類で仕分けると現在地がはっきりする。',
      deploymentStatus: {
        commercial: {
          evidence: 'none',
          body: '第三者企業の現場で業務として使われている事例は、公開情報の範囲では確認できない。',
        },
        poc: {
          evidence: 'limited',
          body: '顧客名・現場・目的が揃う事例は2026年7月時点で限定的である。中国ではエネルギー企業による変電所点検や消防の火災偵察など業務適用に向けた開発案件が出始めているが、いずれも開発段階であり、本番運用の報告ではない。',
        },
        researchEducation: {
          evidence: 'confirmed',
          body: 'NVIDIAとの協業でスタンフォード大学やチューリッヒ工科大学（ETH Zurich）などにH2とJetson Thorが供給されているほか、中国では清華大学・同済大学・中山大学など主要大学への導入が入札ベースで確認できる。もっとも厚みのある使われ方である。',
        },
        exhibitionDemo: {
          evidence: 'confirmed',
          body: 'R1・G1・H1は各種イベント・展示会での実演が多数確認でき、中国ではイベント向けのレンタル市場が品切れになるほど活性化している。',
        },
        internalTrial: {
          evidence: 'confirmed',
          labelOverride: 'あり（自社発表のみ）',
          body: '2026年2月、G1が自社工場でロボット部品を組み立てる様子が公開されたが、根拠はUnitree自身が公開した動画のみで、稼働データや生産性の数値は開示されていない。',
        },
      },
      deploymentOutro:
        '研究・教育、展示・デモ、社内実証が先行し、商用導入の裏付けはまだない——これがUnitreeの現在地である。ただし、この会社の場合「実績がない」は「売れていない」を意味しない。年約5,500台という人型の出荷先の大半が研究・開発市場だという事実はむしろ、Unitreeを「業務の即戦力」としてではなく「検証と開発のプラットフォーム」として調達すべき段階だと示している。',
      japanProcurement:
        '日本国内の窓口はTechShare（Unitree Supported Partner Program参加）、Tohasen Roboticsに加え、2026年6月19日にGMOインターネットグループのGMO AI&ロボティクス商事（GMO AIR）が正規代理店契約を締結し、3社体制になっている。3社は役割が異なる。TechShareは研究・教育向け販売の実績が長く、G1の窓口として案内されている。Tohasen Roboticsはドローン・ロボット専門ストアとして機体販売を行う。GMO AIRは販売に加えて導入支援・ソフトウェア開発・保守運用までのワンストップ提供を掲げており、「機体だけ早く欲しい」のか「導入の伴走まで欲しい」のかで相談先の選び方が変わる。構成はG1/G1 EDU、H2/H2 EDU、R1 AIR/R1/R1 EDUなど細かく分かれ、本体価格に送料・関税・保守費が含まれるかどうかも構成ごとに異なるため、見積の段階で内訳を確認する必要がある。保証期間、修理が国内対応か本国送りか、交換部品の納期、ソフトウェア更新の担当窓口、商用利用時の安全責任の所在、教育用・研究用・商用で契約条件が変わるかどうかは、いずれも公式情報だけでは判断できず、代理店への個別確認が前提になる。加えて、2026年6月に米国防総省がUnitreeを1260Hリストに追加した事実がある。これは米国内の防衛関連調達を対象にした措置で、日本国内の民生調達を直接制限するものではないが、取引先や資金調達に米国企業・投資家が関わる場合は、その影響範囲も合わせて代理店経由で確認しておきたい。',
      faq: [
        {
          question: 'Unitreeのロボットは日本で購入できますか？',
          answer:
            '購入できる。国内窓口はTechShare・Tohasen Robotics・GMO AI&ロボティクス商事（GMO AIR）の3社で、研究・教育向けの機体購入ならTechShare、導入支援や保守まで含めた相談ならGMO AIRというように、目的で相談先を選べる。',
        },
        {
          question: '価格はいくらからですか？',
          answer:
            'Unitree公式の表示価格で、R1 AIRが$4,900〜、G1が$13,500〜、H2が$29,900〜、AI開発プラットフォームのH2 Plusが$100,000（いずれも税・送料別）。日本での実際の支払額は関税・輸送・保守を含めて代理店見積で確認する必要がある。',
        },
        {
          question: '商用の現場でそのまま使えますか？',
          answer:
            '第三者企業の本番運用実績は、2026年7月時点の公開情報では確認できない。現時点の実力は研究・教育・PoC初期の検証プラットフォームであり、業務を置き換える即戦力として調達する段階ではない。',
        },
        {
          question: '米国の1260Hリスト入りは日本企業の調達に影響しますか？',
          answer:
            '1260Hリストは米国防総省の防衛関連調達を対象とした指定で、日本企業の民生調達を直接制限するものではない。ただし取引先や資金調達に米国企業・投資家が関わる場合は影響し得るため、自社の状況に照らした確認が要る。',
        },
        {
          question: 'G1とG1-D、H2とH2 Plusは何が違いますか？',
          answer:
            'G1-Dは二足のG1とは別製品で、車輪ベースに昇降カラムと双腕を載せたデータ収集・開発向けプラットフォーム。H2 PlusはH2のボディをベースにNVIDIA協業で構成されたAI開発プラットフォームで、価格帯も$100,000と別格になる。',
        },
        {
          question: '他社と比べてどういう位置づけですか？',
          answer:
            '価格と量産力では先頭集団だが、商用導入の実績ではAgility RoboticsやFigure AIが先行する。中国勢の中でも、工場の生産ラインへの実装を進めるUBTECHに対し、Unitreeは開発者・研究市場とパフォーマンス性能を重視するという戦略の違いがある。',
        },
      ],
      fitSummary:
        'Unitreeが候補に入りやすいのは、限られた予算でヒューマノイドの検証を始めたい組織である。具体的には、機体を教材・研究プラットフォームとして使う大学・高専・研究機関、社内にロボティクスの知見と学習データを貯めたい事業会社のR&D部門、展示・イベントで体験価値を作りたい用途などだ。R1系・G1は他社のフルサイズ機体の数分の1の本体価格から始められるため、「まず1台入れて社内の解像度を上げる」という稟議が現実的に通る数少ない選択肢であり、この実務面のハードルの低さが最大の武器になる。\n\n一方、本番の業務ラインを今すぐ任せたい企業には向かない。第三者の現場で長期稼働した公開実績がなく、保守SLA・安全認証・交換部品の国内体制はいずれも代理店への個別確認が前提になる。取引先への説明責任が重い上場企業や重要インフラ事業者では、1260Hリストを含む米国関連規制の影響範囲を整理してからでないと社内承認は通しにくい。「安いから試す」で始めてよい組織と、「安くても説明コストが高い」組織がはっきり分かれるメーカーである。\n\n比較対象としては、商用導入の進展を見るならAgility RoboticsやFigure AI、同じ中国勢なら工場実装を重視するUBTECHが戦略の対照になる。フルサイズ機体の将来性で見るならTesla Optimusも比較軸に入る。次に見るべきはG1・H2・R1のロボット詳細ページで、自由度・荷重・稼働時間などの仕様を具体的に比較することだ。問い合わせ前には、構成ごとの価格・納期・保証の内訳と、1260Hリストが自社の取引にどこまで関係するかを整理しておくとよい。',
    },
  },
  {
    ...
    titleJa: 'Agility Roboticsとは——物流・製造現場で先行するDigitメーカーの実力と注意点',
    type: 'manufacturer-guide',
    category: 'company-report',
    section: 'business',
    summary:
      'Agility Roboticsの会社概要、DigitとArcの構成、GXO・Toyota・Mercado Libreなどの商用導入、安全設計、日本からの調達時の確認点を整理する。',
    publishStatus: 'published',
    ...
    relatedUseCaseIds: ['warehouse-picking'],
    whyItMatters:
      'Agility Roboticsは、ヒューマノイドを「研究用の機体」ではなく、RaaS・クラウド運用・安全設計を含む商用自動化パッケージとして売ろうとしている数少ないメーカーである。日本から見ると、すぐ買える安価な開発機ではない一方、物流・製造で本番導入を考える際の比較基準になる。',
    readingTimeMin: 12,
    sources: [
      {
      ...
      {
        title: 'The first humanoid robot factory is about to open',
        url: 'https://www.axios.com/2023/12/05/humanoid-robot-factory-agility-bipedal-amazon',
        publisher: 'Axios',
        publishedAt: '2023-12-05',
        checkedAt: '2026-07-08',
        reliability: 'reported',
        note: 'RoboFabの初期報道、Amazon試験、当時の生産規模・配送計画の第三者報道。',
      },
      {
        title: 'NVIDIA Announces Halos for Robotics, the Industry’s First Full-Stack Safety System for Physical AI',
        url: 'https://nvidianews.nvidia.com/news/nvidia-announces-halos-for-robotics-the-industrys-first-full-stack-safety-system-for-physical-ai',
    ...
    manufacturerGuideContent: {
      companyOverview:
        'Agility Roboticsは、米国オレゴン州セーラムを中心に展開するヒューマノイドメーカーである。2015年にOregon State UniversityのDynamic Robotics Labから生まれ、二足歩行研究機のCassie、研究者向けの初期Digitを経て、現在は物流・製造向けの商用ヒューマノイドDigitを中核製品にしている。\n\n同社の特徴は、機体単体の販売よりも「Digit + Arc + サービス」で現場に入る点にある。Digitは人間向けに設計された倉庫・工場の通路、トート、コンベヤ、AMRなどの既存設備に合わせて使うことを狙い、Arcはクラウド上で配備・監視・フリート管理・既存システム連携を担う。2026年6月にはSPACとの合併による上場予定も発表し、GXO、Schaeffler、Toyota Motor Manufacturing Canada、Mercado Libreなど複数の商用顧客を公表している。一方で、価格、契約単価、日本での販売・保守体制は公開情報だけでは判断しにくい。',
      history:
        'Agilityの起点は、OSUの脚ロボット研究である。2015年にDynamic Robotics Labから会社が設立され、2016年には二足歩行ロボットCassieが歩行を始めた。2017年に出たDigit V1は、現在の商用機というより研究者向けの完全なヒューマノイドとして位置づけられていた。\n\n転機は2023年である。AgilityはDigitを産業顧客向けに再設計し、「研究室から労働現場へ」と会社の軸足を移した。同じ時期にAmazonがDigitの試験を公表し、Axiosはオレゴン州セーラムのRoboFabが年産ピーク1万台を目指す専用工場として立ち上がると報じた。Agility自身も現在、RoboFabを年産1万台規模のフルスケール humanoid factory と説明している。\n\n2025年にはGXOのジョージア州Flowery Branch拠点でDigitが10万トート以上を搬送したと発表された。これは単なるデモではなく、AMRからコンベヤへの積み替えや床上ロケーションへの積み付けを含む、構造化された物流ワークフローでの商用検証である。2025年末にはMercado Libre、2026年2月にはToyota Motor Manufacturing Canadaとの商用契約も発表され、導入先は物流から製造へ広がり始めた。\n\n2026年6月には、Churchill Capital Corp XIとの合併により上場を目指すと発表した。この発表では、9つの顧客施設、累計6万5,000時間超の運用、Digit v5の複数年受注3億ドル超、企業価値25億ドルなどが示された。ただし、これらには将来見通しや契約上のマイルストーンが含まれるため、実績と計画を分けて読む必要がある。',
      productLineup:
        'Agilityのラインナップは、Unitreeのように価格帯の異なる複数機種を並べる構成ではない。中心はDigitで、その上にArcというクラウド自動化プラットフォーム、導入・トレーニング・監視・オンサイトサポートを組み合わせる。検討者は「どのロボットを買うか」よりも、「どの作業をDigitに切り出し、Arcでどう既存システムに接続し、Agilityのサービス体制でどこまでSLAを担保できるか」を見るべきである。\n\nDigitは人間サイズの二足ヒューマノイドで、公式ページでは35ポンド（約16kg）の運搬能力、約4時間のバッテリー、連続シフト運用を前提にした設計が示されている。対象作業は、トート搬送、AMR・コンベヤ連携、物流・製造現場の反復的で身体負荷の高い作業である。現時点で公開されている情報からは、器用な部品組付けや不定形物の高速ピッキングよりも、標準容器と決まった動線を前提にしたマテリアルハンドリングが主戦場と読める。\n\n価格は公開されていない。Agilityの発表はRaaSや商用契約を中心にしており、導入企業ごとに作業範囲、台数、保守、ソフトウェア、現場対応を含めて設計される可能性が高い。初期費用だけで比較するより、月額/年額、稼働保証、停止時対応、ワークセル改修、既存WMS・AMR連携費用まで含めた総額で見る必要がある。',
      lineup: [
        {
          robotId: 'agility-digit',
          roleLabel: '物流・製造向けの商用候補。トート搬送、AMR・コンベヤ連携、標準化されたマテリアルハンドリング向け',
          priceLabel: '要問い合わせ（RaaS/案件別）',
        },
      ],
      evaluationIntro:
        'Agilityは「安く買える開発機」ではなく、商用運用のための統合パッケージとして評価する必要がある。5つの軸で見ると、強みと注意点はかなりはっきり分かれる。',
      evaluationAxes: {
        pricing: {
          level: 'caution',
          body: '価格は公開されていない。RaaSで導入できる可能性は初期投資を抑える利点になるが、実務上は月額・稼働保証・保守・現場改修・システム連携・更新条件が総額を決める。Unitreeのように本体価格を見て稟議を組むタイプではなく、業務KPIと契約条件をセットで見積もる相手である。',
        },
        productionCapacity: {
          level: 'strength',
          body: 'RoboFabは、Agility公式では年産ピーク1万台規模を想定するフルスケールのヒューマノイド工場と説明されている。2026年の上場予定発表では、Digit v5の複数年受注3億ドル超も示された。量産体制を作ろうとしている点は強いが、実際の年間出荷台数、歩留まり、納期、各国への供給優先順位はまだ公開情報だけでは読めない。',
        },
        ecosystem: {
          level: 'strength',
          body: 'Digit単体ではなく、Arcで配備・監視・フリート管理・WMS/MES・AMR連携を扱う構成が明確である。NVIDIA、Google DeepMind、AWS、Manhattanなどのパートナー表示もあり、現場システムとAI基盤の両面でエコシステムを作ろうとしている。ヒューマノイドを社内実験で終わらせず、企業のオペレーションに接続する思想は強い。',
        },
        trackRecord: {
          level: 'strength',
          body: '公開情報上の商用実績は、ヒューマノイドメーカーの中では厚い。GXOでは10万トート搬送、2026年の上場予定発表では9つの顧客施設と6万5,000時間超の運用が示された。Toyota Motor Manufacturing Canada、Mercado Libre、Schaeffler、GXOなどの名前が出ている点も重要である。ただし、稼働率、停止回数、作業単価、回収期間などの運用データは公表されていない。',
        },
        geopoliticalRisk: {
          level: 'caution',
          body: '米国企業であり、中国メーカーに比べると安全保障・制裁面の説明コストは低い。一方で、日本法人・国内代理店・国内保守拠点は公開情報では確認しにくく、米国拠点中心のサービス体制が日本の現場にどこまで届くかは未確認である。SPAC上場予定は資金面の追い風になり得るが、取引完了前の将来見通しでもあるため、契約前には財務・納期・サポート継続性を確認したい。',
        },
      },
      deploymentIntro:
        'Agilityは、研究・展示よりも商用導入の公開情報が目立つ珍しいヒューマノイドメーカーである。ただし現在の商用導入は、基本的に構造化された物流・製造ワークフローから始まっている。',
      deploymentStatus: {
        commercial: {
          evidence: 'confirmed',
          body: 'GXOでの10万トート搬送、Toyota Motor Manufacturing CanadaとのRaaS契約、Mercado Libreのテキサス拠点への導入、Schaefflerを含む顧客名が公式に確認できる。2026年6月時点では、9つの顧客施設と6万5,000時間超の運用も示されている。',
        },
        poc: {
          evidence: 'confirmed',
          body: 'Amazonは2023年にDigitの試験を公表しており、Axios報道ではトートリサイクルなど反復作業の検証が紹介されている。Toyota Motor Manufacturing Canadaの契約も、成功したパイロット後のRaaS契約として発表されている。',
        },
        researchEducation: {
          evidence: 'limited',
          body: '会社の起点はOSUの研究室で、Digit V1も研究者向けの完全なヒューマノイドとして始まった。ただし現在のAgilityは、大学・研究機関向けに安価に配る開発機メーカーではなく、商用現場向けに軸足を移している。',
        },
        exhibitionDemo: {
          evidence: 'limited',
          body: '公式動画・イベント・顧客発表でDigitのデモは確認できるが、Agilityの評価軸は展示映えよりも顧客施設での稼働実績に置くべきである。展示用途だけなら、価格公開された開発機メーカーの方が選びやすい場合がある。',
        },
        internalTrial: {
          evidence: 'limited',
          body: 'RoboFabという自社製造拠点は確認できるが、Digit自身がAgilityの生産工程をどの程度自動化しているかを示す運用データは公開情報では限定的である。自社工場の存在は供給体制の根拠であり、顧客現場の実績とは分けて扱う。',
        },
      },
      deploymentOutro:
        'Agilityの実績は、ヒューマノイド業界の中ではかなり「現場寄り」である。ただし、現場寄りであるほど確認すべき項目も増える。対象作業は標準化されているか、ワークセルを分けられるか、既存WMS・AMR・コンベヤと接続できるか、停止時に人がどう介入するか。Agilityを検討するなら、ロボット性能だけでなく、現場設計と契約設計を同じ重さで見る必要がある。',
      japanProcurement:
        '2026年7月時点の公開情報では、日本法人、国内正規代理店、国内保守拠点は確認できない。日本から検討する場合は、Agility公式サイトの「Deploy Digit」または問い合わせ窓口から、対象国、導入形態、サポート範囲を個別に確認するのが現実的である。\n\n問い合わせ前に整理すべき項目は多い。まず、日本国内でRaaS契約が可能か、または北米顧客を優先する段階なのか。次に、現場調査、ワークセル設計、トレーニング、オンサイト保守、夜間・休日対応、交換部品在庫、通信・クラウドのデータ所在、WMS/MES/AMRとの接続責任がどちらにあるのか。さらに、安全面では、現在のDigitが人と完全に混在して働ける前提ではなく、Agility自身も今日のヒューマノイド導入は分離環境が必要で、Digit v5で協調安全を目指すと説明している点を押さえるべきである。\n\n日本企業が最初に相談するなら、いきなり全社展開を前提にせず、標準容器、限定動線、限定時間帯、明確な停止・退避手順を持つPoCから切るのがよい。価格非公開のため、稟議では「機体代」ではなく、1ワークフローあたりの処理量、代替できる作業時間、停止時の損失、保守SLA、システム連携費まで含めて比較する必要がある。',
      faq: [
        {
          question: 'Agility Digitは日本で購入できますか？',
          answer:
            '公開情報では、日本法人や国内正規代理店は確認できない。購入というより、Agility公式のDeploy Digit窓口からRaaSまたは商用導入の可否を問い合わせる形になる。日本での保守、部品、オンサイト対応、契約通貨、データ管理は個別確認が必要である。',
        },
        {
          question: 'Digitはどんな作業に向いていますか？',
          answer:
            '物流・製造現場の標準化されたマテリアルハンドリングに向く。具体的には、トート搬送、AMRからコンベヤへの積み替え、決まった容器・動線での反復作業などである。器用な組付けや高速な不定形物ピッキングを期待する段階ではない。',
        },
        {
          question: '価格はいくらですか？',
          answer:
            '本体価格は公開されていない。Agilityの発表はRaaSや商用契約が中心で、実際の費用は台数、作業範囲、Arc利用、保守、現場改修、システム連携、SLAで変わる。Unitreeのように公開本体価格から比較するタイプではない。',
        },
        {
          question: 'AgilityとUnitreeの違いは何ですか？',
          answer:
            'Unitreeは低価格・量産・研究開発市場に強い。一方、Agilityは価格公開や国内購入のしやすさでは劣るが、商用RaaS、現場統合、顧客施設での稼働実績、安全設計を前面に出している。研究用にまず1台触るならUnitree、物流・製造の本番導入を検討するならAgilityが比較軸になる。',
        },
        {
          question: '商用実績はどこまで確認できますか？',
          answer:
            'GXOでの10万トート搬送、Toyota Motor Manufacturing CanadaとのRaaS契約、Mercado Libreの物流拠点導入、Schaefflerを含む商用顧客名が公式に確認できる。2026年6月の上場予定発表では9施設・6万5,000時間超の運用も示された。ただし、稼働率や費用対効果の詳細は未公開である。',
        },
        {
          question: '安全面はどう見ればよいですか？',
          answer:
            'Agilityは安全を強く打ち出しており、Digitの認証、NVIDIA Halosとの協業、Digit v5での協調安全を説明している。ただし現在のヒューマノイド導入は人とロボットの作業領域を分ける前提が残る。日本で導入する場合は、現場のリスクアセスメント、非常停止、作業区域分離、保守時手順を契約前に詰める必要がある。',
        },
      ],
      fitSummary:
        'Agilityが向くのは、物流・製造現場で「人型でなければ入りにくいが、作業自体は標準化できる」領域を持つ企業である。標準トート、決まった搬送ルート、AMR・コンベヤ・WMSとの接続、限定された作業区域、停止時の人手介入手順があるなら、Agilityはかなり有力な比較対象になる。GXO、Toyota Motor Manufacturing Canada、Mercado Libreのように、既存の自動化設備と人手作業の間を埋める用途が読みやすい。\n\n一方で、日本で安く早く実機を買って研究したい組織には向かない。価格は非公開で、国内代理店や国内保守は確認しにくく、問い合わせから現場設計までのハードルが高い。大学・研究室・展示用途なら、UnitreeやBooster Roboticsのような価格公開された開発機の方が現実的なことが多い。\n\n比較対象は、商用実績重視ならFigure AIやApptronik、価格と開発者市場ならUnitree、物流ワークフローの完成度ならAgilityという整理になる。問い合わせ前には、対象作業の処理量、現行人員コスト、例外発生率、ワークセル分離可否、既存システム接続、保守SLAの希望水準をまとめておくとよい。Agilityは「ロボットを買う相手」ではなく、「現場ワークフローを共同で自動化する相手」と見た方が判断を誤りにくい。',
    },
  },
];

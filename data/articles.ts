  ...
  },
  {
    ...
    manufacturerGuideContent: {
      ...
      deploymentStatus: {
        ...
        poc: {
          evidence: 'limited',
          body: 'Toyota Motor Manufacturing CanadaとのRaaS契約は、成功したパイロット後の契約として発表されている。ただし、PoC単体の期間、台数、評価指標を細かく比較できる公開情報は限られる。',
        },
        researchEducation: {
          evidence: 'limited',

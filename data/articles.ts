...
もう一つは**ベンダーリスクの評価**。需要が追いつかない中での過剰生産は、財務健全性の悪化→撤退・買収というリスクシナリオにつながる。「5年後もサポートを受けられるか」というベンダー継続性の評価を今から始めておくことが重要だ。`,
  ...
  },
  {
    ...
    heroImage: {
      ...
      sourceUrl: 'https://bostondynamics.com/atlas/',
      rights: {
        status: 'blocked',
        sourceType: 'manufacturer-official',
        ...
        checkedAt: '2026-06-19',
        permissionNote:
          '2026-06-13に bostondynamics.com/atlas/ の製品ページ画像を reference-attributed として登録していたが、2026-06-19にBoston DynamicsのTerms of Use (bostondynamics.com/terms/) を確認したところ「commercial enterpriseでの利用には書面の事前同意が必要」「Boston Dynamicsは知的財産権を積極的に行使する」と明記されており、規約違反のおそれがあるため非表示化。',
      },
    },
    whyItMatters:
...
NEO の安全設計は家庭利用前提だ。産業現場での利用には安全評価・責任分界の整理が別途必要になる。また米国向け予約のため、日本での調達・保守サポートは現時点で未確認。価格モデルの参照としては有益だが、実導入候補としての評価は別フェーズで行うことを推奨する。`,
  ...
  // ── 2026年 追加記事（第2弾）──────────────────────────────────────────
  {
    ...
    author: 'Deploid Research',
    tags: ['tesla', 'optimus', 'production', 'manufacturing', 'commercial'],
    heroImage: {
      src: '',
      alt: 'Tesla Optimus humanoid robot at Fremont factory',
      credit: 'Tesla',
      rights: {
        status: 'reference-attributed',
        sourceType: 'manufacturer-official',
...
- **日本代理店**：現時点で国内代理店・保守体制は未公表（要確認）`,
  ...
  },
  {
    ...
    publishedAt: '2026-06-15',
    author: 'Deploid Research',
    tags: ['japan', 'policy', 'market', 'analysis'],
    heroImage: {
      src: '',
      alt: 'Japan METI physical AI policy and robot industry',
      credit: '',
      rights: {
        status: 'reference-attributed',
        sourceType: 'unknown',
...
**2040年目標の読み方**：ただし、「目標設定」と「実行成果」が乖離してきた日本の産業政策の歴史を踏まえると、METIが掲げる30%シェアを額面通りに受け取るのはリスクがある。FY2026予算の執行先と、2027年以降の進捗指標を追跡することで、政策の実効性を継続的に評価することが必要だ。目標よりも「今から3年間でどこに補助金が流れるか」の方が、個別企業の導入判断に直接影響する。`,
  ...
  },
  {
    ...
    publishedAt: '2026-06-15',
    author: 'Deploid Research',
    tags: ['japan', 'market', 'deployment', 'commercial', 'analysis'],
    heroImage: {
      src: '',
      alt: 'Humanoids Summit Tokyo 2026 at Takanawa Convention Center',
      credit: 'Humanoids Summit',
      rights: {
        status: 'reference-attributed',
        sourceType: 'unknown',
        checkedAt: '2026-06-15',
...
「誰が来ていないか」もチェックポイントだ。Tesla・Figure AIといったトップ企業が出席しているかどうかは、彼らの日本市場優先度の目安になる（要確認）。一方でBooster・LimXといった中国新興企業が積極的に参加したことは、中国製機体が日本市場を直接開拓しようとしていることを示す。`,
    ...
    relatedUseCaseIds: ['factory-inspection', 'demo-exhibition'],
    relatedGuideIds: ['decision-variables'],
    sources: [
      {
  ...
  },
  {
    ...
    publishedAt: '2026-06-15',
    author: 'Deploid Research',
    tags: ['apptronik', 'funding', 'mercedes-benz', 'manufacturing', 'deployment', 'commercial'],
    heroImage: {
      src: '',
      alt: 'Apptronik Apollo humanoid robot in factory setting',
      credit: 'Apptronik',
      rights: {
        status: 'reference-attributed',
        sourceType: 'manufacturer-official',
...
Apptronikは日本国内の代理店・保守体制を現時点（2026年6月）では公表していない（要確認）。ただしApolloは既に国際的な関心を集めており、日本への参入を検討していると示唆するシグナルも出ていると言われるが、正式な発表はない。`,
  ...
  },
  {
    ...
    publishedAt: '2026-06-15',
    author: 'Deploid Research',
    tags: ['boston-dynamics', 'autonomous', 'research', 'manufacturing'],
    heroImage: {
      src: '',
...
産業現場への適用を検討する際は、「Gemini Roboticsがどの環境・どのタスクで実稼働実績を持つか」を具体的に確認することが必要だ。`,
  ...
  },
  {
    ...
    publishedAt: '2026-06-15',
    author: 'Deploid Research',
    tags: ['japan', 'market', 'analysis', 'deployment', 'policy'],
    heroImage: {
      src: '',
      alt: 'Japan humanoid robot labor strategy and workforce challenge',
      credit: '',
      rights: {
        status: 'reference-attributed',
        sourceType: 'unknown',
...
**1. JAL羽田実証（2026年4月〜）**：JALグランドサービスとGMO AI & Roboticsが組み、国内航空会社として初めてヒューマノイド（Unitree G1ベース）を空港現場に投入した（別記事参照）。航空という安全規制の厳しい現場での実証は、他業種への「許可証」に近い心理的効果がある。
...
「何年後かに本格導入する」計画でも、「今すぐ情報収集・問い合わせ・PoC予算確保」を始めないと、リードタイムの計算が狂う。`,
  ...
  },
  {
    ...
    author: 'Deploid Research',
    tags: ['unitree', 'pricing', 'production', 'consumer', 'market'],
    heroImage: {
      src: '',
...
Unitree Roboticsが公式サイトで、量産二足ロボット「R1」シリーズの構成を明確化した。エントリーモデルの「R1 AIR」が4,900ドルから、自由度を高めた標準モデル「R1」が5,900ドルから、研究・二次開発向けの「R1 EDU」は要問い合わせという3段階の価格帯が、2026年6月17日時点でUnitree公式サイト上で確認できる。R1 AIRは身長123cm・重量27kg・自由度20、R1は同じ筐体で自由度を26まで高めた構成だ。

## 中国国内の競合機種と比べた価格の位置

Unitreeの自社ラインアップで見ても、R1の安さは際立つ。同社のG1（身長130cm・重量35kg）は99,000元からで、ヒト型として上位に位置するH1（身長180cm・重量47kg）は65万元からだ。競合のEngineAI製PM01（身長138cm）は88,000元、UBTech Roboticsの機種は29.9万元という値付けで、South China Morning Postの報道はR1の価格を中国の競合と比べても安いと位置づけている。R1の本体価格は39,999元（約5,900ドル）で、量産二足ロボットとしては現時点で最も入手しやすい価格帯の一つだ。

## 国際販売チャネルの拡大が先行していた

価格の安さに加えて見ておくべきは販売チャネルの動きだ。South China Morning Postは2026年4月9日付の報道で、Unitreeが翌週にもAliExpress経由でR1の海外販売を開始する計画だと、事情に詳しい関係者2名の証言を基に報じている。対象地域には北米・欧州・日本・シンガポールが含まれるとされ、国際価格は当時未公表だった。つまりR1は中国国内限定の安価モデルではなく、最初から海外個人購入者・研究機関を見込んだ設計だったことになる。

## 日本企業が確認すべきこと

R1自体は重量物ハンドリングを想定した機体ではなく、Unitreeのデータでもペイロードは大きくない。法人の主力導入機としてではなく、社内デモ・展示・運動制御の実証用途で評価する位置付けが妥当だ。日本企業が次に確認すべき点は、(1)日本向け正規販売・保守ルートがAliExpress経由の個人輸入と別に整備されるか、(2)R1 EDUの具体的な価格と二次開発条件、(3)この価格帯がG1やH1など主力機の今後の価格設定にどう波及するか、の3点だ。量産二足ロボットの価格下限が下がり続けていること自体は、ヒューマノイド評価のコスト感覚を見直す材料になる。`,
  ...
  },
  {
    ...
    publishedAt: '2026-06-19',
    author: 'Deploid Research',
    tags: ['dobot', 'japan', 'manufacturing', 'demo'],
    heroImage: {
      src: '',
      alt: 'DOBOT ATOM Max humanoid robot',
      credit: 'DOBOT Robotics',
      sourceUrl: 'https://www.robot-digest.com/contents/?id=1779354310-953620',
      rights: {
        status: 'reference-attributed',
        sourceType: 'manufacturer-official',
        rightsHolder: 'DOBOT Robotics',
        checkedAt: '2026-06-19',
      },
    },
    whyItMatters:
...
今回の出展はデモンストレーションの段階で、量産ラインへの本格投入時期や日本向けの価格・保守体制は公表されていない（要確認）。日本市場では中国メーカーのヒューマノイドが相次いで展示会デビューする動きが続いており、ATOM Maxもその一例だ。日本企業が検討する際は、デモの完成度だけでなく、国内サポート体制・部品供給・ファームウェア更新の運用方針を、正式な代理店契約の前に確認することが欠かせない。`,
    relatedRobotIds: [],
    relatedManufacturerIds: [],
    relatedUseCaseIds: ['demo-exhibition'],
  ...
  },
  {
    ...
    publishedAt: '2026-06-19',
    author: 'Deploid Research',
    tags: ['vietnam', 'market', 'research', 'autonomous'],
    heroImage: {
      src: '',
      alt: 'VinDynamics Dyno humanoid robot',
      credit: 'VinDynamics / Vingroup',
      sourceUrl: 'https://pulse2.com/vindynamics-debuts-dyno-humanoid-robot-at-icra-2026-and-computex-taipei-2026/',
      rights: {
        status: 'reference-attributed',
        sourceType: 'manufacturer-official',
        rightsHolder: 'Vingroup',
        checkedAt: '2026-06-19',
      },
    },
    whyItMatters:
...
Dynoは多言語での案内・接客、訪問者の質問への応答、都市部やキャンパス・複合施設でのセキュリティ・監視を主な用途とする。Vingroupが運営するベトナム最大級の野生動物保全公園「Vinpearl Safari Phu Quoc」で実証プログラムを実施しており、屋外という動的な環境で安定稼働した実績を持つ。一方のVR-H3は31以上のアクチュエーターとデュアルエッジコンピューターを搭載し、ペイロード6〜8kgで資材搬送・組立支援・危険環境での作業を想定する。外部トラッカー不要でVRヘッドセットとモーションキャプチャーを組み合わせた遠隔操作にも対応する。

## 同じグループが2社で住み分ける狙い

DynoとVR-H3は開発元が異なる別会社の製品で、Vingroupはサービス向けと産業向けを別法人で並走させる体制を取っている。これは単一企業がヒューマノイドの全用途を一手に開発するモデルとは異なり、サービスロボットと産業ロボットでは安全要件・認証・販売チャネルが大きく異なることを踏まえた住み分けと見られる。Vingroup自体は不動産・自動車（VinFast）・小売など幅広い事業を持つコングロマリットであり、グループ内の実証フィールド（テーマパーク、製造拠点など）を自社製品の実証に使える点が強みだ。

## 中国・米国に次ぐ供給国の広がり

ヒューマノイド開発は中国（Unitree、AGIBOT、UBTechなど）と米国（Figure、Apptronik、Boston Dynamicsなど）が先行してきたが、Vingroupの参入は東南アジアからの新規参入として位置付けられる。実証実績はまだ自社グループ内の施設が中心で、外部企業への販売条件や日本含む海外展開の計画は今回の発表時点では明らかにされていない（要確認）。

## 日本企業が見ておくべき点

現時点でDyno・VR-H3ともに日本向けの販売・代理店情報はない。ただし、ヒューマノイドの供給元が中国・米国の数社に限られない状況が生まれつつあることは、将来の調達先選定において選択肢が増える可能性を示す。日本企業としては、(1)Vingroupグループ内実証の継続的な成果公表、(2)VR-H3の認証・安全規格の取得状況、(3)海外（特にアジア圏）への販売条件、の3点を継続的に確認する価値がある。`,
    relatedRobotIds: [],
    relatedManufacturerIds: [],
    relatedUseCaseIds: [],
    relatedGuideIds: ['decision-variables'],
  ...
  },
  {
    ...
    publishedAt: '2026-06-19',
    author: 'Deploid Research',
    tags: ['genesis-ai', 'research', 'autonomous', 'production'],
    heroImage: {
      src: '',
      alt: 'Genesis AI Eno general-purpose robot',
      credit: 'Genesis AI',
      sourceUrl:
        'https://www.prnewswire.com/news-releases/introducing-eno-genesis-ais-first-general-purpose-robot-is-challenging-traditional-humanoid-design-302801103.html',
      rights: {
        status: 'reference-attributed',
        sourceType: 'manufacturer-official',
...
Enoのような非ヒューマノイド型の汎用ロボットは、二足歩行機よりも導入コスト・保守難易度が低くなる可能性がある一方、対応できる作業範囲は限定される。日本企業が評価する際は、(1)2026年末という量産タイムラインの実現性、(2)製造・物流現場での実証データの公開状況、(3)二足歩行を前提にした既存の現場レイアウトとの相性、を確認する必要がある。人型である必要が本当にあるかを再考する材料として、今後の評価軸に加える価値がある。`,
    relatedRobotIds: [],
    relatedManufacturerIds: [],
    relatedUseCaseIds: ['warehouse-picking', 'research-development'],
    relatedGuideIds: ['decision-variables'],
    sources: [
      {
      ...
      {
        title: 'Genesis AI unveils Eno, a general-purpose robot powered by its GENE foundation model',
        url: 'https://roboticsandautomationnews.com/2026/06/17/genesis-ai-launches-first-general-purpose-humanoid-robot/102623/',
  ...
  },
  {
    ...
    publishedAt: '2026-06-19',
    author: 'Deploid Research',
    tags: ['j-hrti', 'physical-ai', 'japan', 'research', 'manufacturing'],
    heroImage: {
      src: '',
      alt: 'J-HRTI physical AI robot data collection center in Chiba',
      credit: '株式会社山善',
...
このコンソーシアムの特徴は、政府主導ではなく民間企業4社だけで構成されている点にある。漢方薬大手のツムラ、食品機械のレオン自動機、産業機械商社の山善という、ロボットメーカーではない事業会社が中心になっているのも特徴的だ。狙いは、ヒューマノイドロボットの模倣学習（imitation learning）に必要なフィジカルデータを大規模に生成・共有することにある。ロボット単体の性能ではなく、現場作業を模した動作データそのものを資産として位置付け、日本国内でヒューマノイドの社会実装を進める基盤を作る発想だ。
...
製造業・物流業がヒューマノイド導入を検討する際、最大のハードルの一つは自社の現場に合わせた動作をどう学習させるかという点だ。J-HRTIのような専用データ収集拠点が国内に生まれることは、海外メーカーの汎用モデルに依存しない、日本の現場特性に合わせたデータ基盤が育つ可能性を示す。同種の現場（多品種少量生産、繊細なハンドリングが必要な工程など）を持つ企業にとっては、(1)このセンターが将来外部企業のデータ収集ニーズを受け入れるか、(2)生成されたデータやモデルの提供条件、(3)2026年7月の開業後の実際の稼働実績、を継続的に確認する価値がある。`,
    relatedRobotIds: [],
    relatedManufacturerIds: [],
    relatedUseCaseIds: ['research-development'],
    relatedGuideIds: ['decision-variables', 'poc-planning'],

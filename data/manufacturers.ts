...
export const manufacturers: Manufacturer[] = [
  ...
  },
  {
    ...
    heroImage: {
      src: '',
      alt: 'TX GHOST robot in convenience store',
      credit: 'Telexistence',
      sourceUrl: 'https://tx-inc.com/',
      rights: {
        status: 'reference-attributed',
    ...
    summary: 'コンビニ棚補充ロボット TX GHOST を中心に、国内小売現場での遠隔操作型ヒューマノイドを展開する日本のスタートアップ。',
    publishStatus: 'published',
    updatedAt: '2026-06-30',
    reliability: 'official',
    sources: [
      {
        title: 'Telexistence official website',
    ...
    description: '2017年東京創業。遠隔操作技術と AI を組み合わせたヒューマノイド TX GHOST をコンビニエンスストア（FamilyMart 等）の棚補充向けに展開。日本の小売現場での実証・実用化で先行している。',
    japanPresence: 'office',
    procurementNote: '直販・パートナー経由での導入交渉。法人向け問い合わせフォームあり。',

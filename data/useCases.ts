    ...
    sources: [
      {
        ...
        note: 'Digit の物流・マテハン向け位置付けの裏取り。Amazon/GXOの個別導入URLは2026-06-26時点で再確認できなかったため、strong根拠から外した。',
      },
      {
    ...
    candidateRobots: [
      {
        ...
        reason: '物流・マテハン向けの位置付けは確認できるが、現行確認できる公開出典だけでは個別導入事例をstrong根拠として扱わない。',
      },
      {
        robotId: 'figure-03',
        fit: 'possible',
    ...
    sources: [
      {
        ...
        reliability: 'official',
        note: 'TALOS の研究向け製品能力の裏取り。Waterloo RoboHub導入はこの出典だけでは確認できないため、strong根拠から外した。',
      },
      {
    ...
    candidateRobots: [
      {
        ...
        reason: '研究向けプラットフォームとしての製品能力は確認できるが、現行確認できる公開出典だけでは特定研究機関への導入事例をstrong根拠として扱わない。',
      },
      {
        robotId: 'unitree-g1',
        fit: 'possible',
  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        checkedAt: '2026-06-26',
        reliability: 'official',
        note: 'Walker S1 の工場向け製品能力の裏取り。NIO導入URLは2026-06-26時点で再確認できなかったため、strong根拠から外した。',
      },
    ],
    heroImage: {
      src: '',
    ...
    candidateRobots: [
      ...
      },
      {
        ...
        reason: '工場向け製品能力は確認できるが、NIO導入URLが現行確認できないため、この用途のstrong根拠としては扱わない。',
      },
      {
        robotId: 'figure-03',
        fit: 'possible',

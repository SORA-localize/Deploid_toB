...
export const useCases: UseCase[] = [
  ...
  // --- E-05: 医療・介護（healthcare）5件 ---
  {
    ...
    reliability: 'reported',
    sources: [
      { title: 'Aeolus Robotics aeo product page', url: 'https://aeolusbot.com/', publisher: 'Aeolus Robotics', checkedAt: '2026-06-30', reliability: 'official' },
    ],
    maturityLevel: 'production-ready',
    buyerReadiness: 'initial-adoption',
    environment: 'indoor-controlled',
    ...
    candidateRobots: [
      { robotId: 'aeolus-aeo', fit: 'possible', basis: 'official-use-case', evidenceSourceUrls: ['https://aeolusbot.com/'], reason: 'Aeolus Robotics aeo が病院向け検体・物品搬送を主要ユースケースとして公式に訴求。日本医療機関への導入実績あり。' },
    ],
  },
  {
  ...
  },
  {
    ...
    candidateRobots: [
      { robotId: 'aeolus-aeo', fit: 'possible', basis: 'official-use-case', evidenceSourceUrls: ['https://aeolusbot.com/'], reason: 'Aeolus aeo が介護・医療施設での見守り巡回を公式ユースケースとして訴求。日本施設への導入実績あり。' },
    ],
  },
  {
    ...
    candidateRobots: [
      { robotId: 'aeolus-aeo', fit: 'possible', basis: 'official-use-case', evidenceSourceUrls: ['https://aeolusbot.com/'], reason: 'Aeolus aeo が医療施設での消毒・清掃業務を公式ユースケースとして訴求。日本医療機関への導入実績あり。' },
    ],
  },
  {
  ...
  // --- E-06: 小売・店舗（retail）3件 ---
  {
    ...
    candidateRobots: [
      { robotId: 'aeolus-aeo', fit: 'possible', basis: 'official-use-case', evidenceSourceUrls: ['https://aeolusbot.com/'], reason: 'Aeolus aeo がホテルのルームサービス配送用途で実証実績あり。' },
    ],
  },
  {
    ...
    reliability: 'reported',
    sources: [
      { title: 'Galbot official website', url: 'https://galbot.com/', publisher: 'Galbot', checkedAt: '2026-06-30', reliability: 'official' },
    ],
    maturityLevel: 'production-ready',
    buyerReadiness: 'requires-poc',
    environment: 'indoor-semi-controlled',
    ...
    candidateRobots: [
      { robotId: 'galbot-g1', fit: 'possible', basis: 'official-use-case', evidenceSourceUrls: ['https://galbot.com/'], reason: 'Galbot G1 が飲食店配膳ユースケースを主力として商用化を進めている。' },
    ],
  },
  {
    id: 'retail-barista',
    ...
    candidateRobots: [
      { robotId: 'galbot-g1', fit: 'possible', basis: 'official-use-case', evidenceSourceUrls: ['https://galbot.com/'], reason: 'Galbot G1 がバリスタ調理を主力商業ユースケースとして量産商品化を進めている。' },
    ],
  },
  ...
  },
  {
    ...
    candidateRobots: [
      { robotId: 'aeolus-aeo', fit: 'possible', basis: 'official-use-case', evidenceSourceUrls: ['https://aeolusbot.com/'], reason: 'Aeolus aeo が商業施設・医療機関での道案内・館内ガイドを公式ユースケースとして訴求。日本での導入実績あり。' },
      {
        robotId: 'xpeng-iron',
        fit: 'possible',
        basis: 'official-use-case',
  ...
  },
  {
    ...
    candidateRobots: [
      { robotId: 'aeolus-aeo', fit: 'possible', basis: 'official-use-case', evidenceSourceUrls: ['https://aeolusbot.com/'], reason: 'Aeolus aeoが施設での巡回・警備補助ユースケースに対応している。' },
    ],
  },
  {
    ...
    candidateRobots: [
      { robotId: 'aeolus-aeo', fit: 'possible', basis: 'official-use-case', evidenceSourceUrls: ['https://aeolusbot.com/'], reason: 'Aeolus aeo が施設内の物品整理・片付け補助ユースケースを実証している。' },
    ],
  },

...
export const useCases: UseCase[] = [
  {
    ...
    sources: [
      ...
      {
        title: 'ENGINEAI T800 official product page',
        url: 'https://www.engineai.com.cn/product-t800.html',
        publisher: 'EngineAI',
        checkedAt: '2026-07-17',
        reliability: 'official',
        note: '物流仓储（物流倉庫）を対象用途として明記。',
      },
    ],
    ...
    candidateRobots: [
      ...
      {
        robotId: 'engineai-t800',
        fit: 'possible',
        basis: 'official-use-case',
        evidenceSourceUrls: ['https://www.engineai.com.cn/product-t800.html'],
        reason: '公式製品ページが「物流仓储」（物流倉庫）をT800シリーズ共通の対象用途として示している。edition別の数値仕様は未確定。',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      ...
      {
        title: 'Walker Tienkung — Academic Research & Education',
        url: 'https://www.ubtrobot.com/en/ai-education/products/walker-tienkung',
        publisher: 'UBTECH Robotics',
        checkedAt: '2026-07-17',
        reliability: 'official',
        note: '「学術研究・教育・二次開発向けフルサイズヒューマノイド」とTK2101/TK2201/TK2301共通で明記。',
      },
      {
    ...
    candidateRobots: [
      ...
      },
      {
        ...
        basis: 'official-use-case',
        evidenceSourceUrls: ['https://www.robotera.com/application.html'],
        reason: '公式サイトがM7の対象用途として科学研究（データ収集・モデル学習）を示している。robotera.com本体はJS描画のためRBTX等での再確認が望ましい。',
      },
      {
        robotId: 'ubtech-walker-tienkung',
        fit: 'possible',
        basis: 'official-use-case',
        evidenceSourceUrls: ['https://www.ubtrobot.com/en/ai-education/products/walker-tienkung'],
        reason: '公式ページが「学術研究・教育・二次開発向けフルサイズヒューマノイド」とTK2101/TK2201/TK2301共通で明記している。',
      },
    ],
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        checkedAt: '2026-07-17',
        reliability: 'official',
        note: '"Exhibition & Event Guidance"をOli全構成共通の対象用途として明記。',
      },
      {
        ...
        checkedAt: '2026-07-17',
        reliability: 'official',
        note: 'テーマパーク・ライブステージでの群舞・演出機能を明記。',
      },
    ],
    maturityLevel: 'pilot-phase',
    buyerReadiness: 'initial-adoption',
    ...
    candidateRobots: [
      ...
      },
      {
        ...
        basis: 'official-use-case',
        evidenceSourceUrls: ['https://www.limxdynamics.com/en/products/oli'],
        reason: '公式ページが「Exhibition & Event Guidance」をOli全構成共通の対象用途として示している。',
      },
      {
        robotId: 'limx-luna',
        fit: 'possible',
        basis: 'official-use-case',
        evidenceSourceUrls: ['https://www.limxdynamics.com/en/products/luna'],
        reason: '公式ページがテーマパーク・ライブステージでの群舞・演出機能をLunaの対象用途として示している。',
      },
    ],
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        url: 'https://www.agibot.com/products/A2_Ultra',
        publisher: 'AgiBot',
        checkedAt: '2026-07-17',
        reliability: 'official',
      },
    ...
    candidateRobots: [
      ...
      {
        robotId: 'agibot-a2-ultra',
        fit: 'possible',
        basis: 'official-use-case',
        evidenceSourceUrls: ['https://www.agibot.com/products/A2_Ultra'],
        reason: '公式ページが「展示ホールの案内役」として顔認識による自律受付・積極的な挨拶を対象用途として示している。',
      },
      {
        robotId: 'engineai-t800',
        fit: 'possible',
        basis: 'official-use-case',
        evidenceSourceUrls: ['https://www.engineai.com.cn/product-t800.html'],
        reason: '公式製品ページが「门店导购」（店舗接客案内）をT800シリーズ共通の対象用途として示している。edition別の数値仕様は未確定。',
      },
      {
        robotId: 'robotera-q5',
        fit: 'possible',
        basis: 'official-use-case',
        evidenceSourceUrls: ['https://www.robotera.com/application.html'],
        reason: '公式サイトが企業受付・接客アシスタント用途をQ5の対象用途として示している。',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        checkedAt: '2026-07-17',
        reliability: 'official',
        note: '工厂协作（工場協働作業）をT800シリーズ共通の対象用途として明記。',
      },
      {
        title: 'Manufacturing',
    ...
    candidateRobots: [
      ...
      },
      {
        ...
        basis: 'official-use-case',
        evidenceSourceUrls: ['https://www.engineai.com.cn/product-t800.html'],
        reason: '公式製品ページが「工厂协作」（工場協働作業）をT800シリーズ共通の対象用途として示している。edition別の数値仕様は未確定。',
      },
    ],
  },
  ...
  },
  {
    ...
    candidateRobots: [
      ...
      { robotId: 'ubtech-walker-s1', fit: 'possible', basis: 'official-use-case', evidenceSourceUrls: ['https://www.ubtrobot.com/en/humanoid/solutions/industry'], reason: '公式産業ソリューションが資材搬送とAMR/AGVとの自律連携をWalker S1の対象用途として示している。' },
  ...
  },
  {
    ...
    candidateRobots: [
      ...
      { robotId: 'ubtech-walker-s2', fit: 'possible', basis: 'official-use-case', evidenceSourceUrls: ['https://www.ubtrobot.com/en/humanoid/solutions/industry'], reason: '公式産業ソリューションが品質検査（Quality Inspection）をWalker S/S1/S2共通の対象用途として示している。' },
      {
        robotId: 'apptronik-apollo',
        fit: 'possible',
        basis: 'official-use-case',
  ...
  },
  {
    ...
    candidateRobots: [
      ...
      },
      {
        ...
        fit: 'possible',
        basis: 'official-use-case',
        evidenceSourceUrls: ['https://bostondynamics.com/wp-content/uploads/2026/01/atlas-spec-sheet.pdf'],
        reason: '公式Sales Sheetが倉庫・工場タスク（部品シーケンシング、マシンテンディング、注文フルフィルメント等）への対応をAtlasの対象用途として示している。',
      },
    ],
  },
  ...
  // --- E-05: 医療・介護（healthcare）5件 ---
  {
    ...
    overview: '病院内の検体・物品搬送は、定型ルートと受け渡し手順を設計しやすい自動化候補。Galbot G1とAeolus aeoが公式用途として訴求している。',
    ...
    candidateRobots: [
      ...
      },
      {
        ...
        fit: 'possible',
        basis: 'official-use-case',
        evidenceSourceUrls: ['https://www.prnewswire.com/news-releases/aeolus-debuts-autonomous-dual-arm-humanoid-robot-at-ces-301713109.html'],
        reason: 'Aeolusの公式発表が病院での医療物資配送を現行aeoの用途として示している。',
      },
    ],
  },
  {
  ...
  // --- E-06: 小売・店舗（retail）3件 ---
  {
    ...
    sources: [
      {
        ...
        checkedAt: '2026-07-17',
        reliability: 'official',
        note: '酒店服务（ホテルサービス）をT800シリーズ共通の対象用途として明記。',
      },
    ],
    maturityLevel: 'early-stage',
    buyerReadiness: 'limited-today',
    ...
    overview: 'ホテル内配送は自動化候補。EngineAI T800が公式に酒店服务（ホテルサービス）を対象用途として掲げている。',
    ...
    candidateRobots: [
      {
        ...
        basis: 'official-use-case',
        evidenceSourceUrls: ['https://www.engineai.com.cn/product-t800.html'],
        reason: '公式製品ページが「酒店服务」（ホテルサービス）をT800シリーズ共通の対象用途として示している。edition別の数値仕様は未確定。',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    candidateRobots: [
      ...
      },
      {
        ...
        basis: 'official-use-case',
        evidenceSourceUrls: ['https://www.robotera.com/application.html'],
        reason: '公式サイトがモール案内・病院内道案内をQ5の対象用途として示している。',
      },
    ],
  },
  {
    ...
    sources: [
      ...
      { title: 'Meet aeo', url: 'https://www.aeolusbot.com/meet-aeo', publisher: 'Aeolus Robotics', checkedAt: '2026-07-16', reliability: 'official' },
      {
        title: 'EngineAI targets public security and traffic management applications',
        url: 'https://www.engineai.com.cn/about-news-media/53.html',
        publisher: 'EngineAI',
        checkedAt: '2026-07-17',
        reliability: 'official',
        note: 'T800を軸とした智慧警務ロボット産業エコシステム構築（公安交通管理・公共安全分野）を公表。',
      },
    ],
    maturityLevel: 'pilot-phase',
    buyerReadiness: 'requires-poc',
    ...
    candidateRobots: [
      ...
      { robotId: 'engineai-t800', fit: 'possible', basis: 'official-use-case', evidenceSourceUrls: ['https://www.engineai.com.cn/about-news-media/53.html'], reason: '公式発表がT800を軸に公安交通管理・公共安全分野向けの智慧警務ロボット産業エコシステム構築を示している。実際の公道稼働実績は現時点でPM01名義のみ確認できており、T800自体の実運用は未確認。' },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      ...
      {
        title: 'AgibotTech GitHub organization',
        url: 'https://github.com/AgibotTech',
        publisher: 'AgiBot',
        checkedAt: '2026-07-17',
        reliability: 'official',
        note: 'X1をフルスタックオープンソースロボットとして、推論・学習コードを二次開発向けに公開。',
      },
      {
        title: 'Walker Tienkung — Academic Research & Education',
        url: 'https://www.ubtrobot.com/en/ai-education/products/walker-tienkung',
        ...
        checkedAt: '2026-07-17',
        reliability: 'official',
        note: '全関節・センサーへのオープンインターフェース、URDFモデル、オープンソース学習フレームワークを対象用途として明記。TK2101/TK2201/TK2301共通。',
      },
    ],
    maturityLevel: 'pilot-phase',
    buyerReadiness: 'requires-poc',
    ...
    candidateRobots: [
      ...
      },
      {
        ...
        fit: 'possible',
        basis: 'official-use-case',
        evidenceSourceUrls: ['https://github.com/AgibotTech'],
        reason: '公式GitHub組織がX1をフルスタックオープンソースロボットとして位置付け、推論・学習コードを二次開発向けに公開している。',
      },
      {
        robotId: 'ubtech-walker-tienkung',
        fit: 'possible',
        basis: 'official-use-case',
        evidenceSourceUrls: ['https://www.ubtrobot.com/en/ai-education/products/walker-tienkung'],
        reason: '公式ページが全関節・センサーへのオープンインターフェース、URDFモデル、オープンソース学習フレームワークをTK2101/TK2201/TK2301共通の対象用途として示している。',
      },
    ],
  },
];

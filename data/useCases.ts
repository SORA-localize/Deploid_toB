    ...
    sources: [
      {
        ...
        checkedAt: '2026-06-21',
        reliability: 'official',
        note: 'Renaultドゥエー工場でのCALVIN-40量産導入規模の裏取り（最も成熟した事例として overview で引用）。',
      },
      {
        title: 'BMW Group completes successful trial run with humanoid robots at Plant Spartanburg',

    ...
    sources: [
      {
        ...
        note: 'Digit の Amazon 倉庫実証（data/deployments.ts の agility-amazon-sumner と同一出典）。',
      },
      {
        ...
        checkedAt: '2026-06-01',
        reliability: 'official',
        note: 'Digit の GXO 商用契約（data/deployments.ts の agility-gxo-flowery-branch と同一出典）。',
      },
      {
    ...
    candidateRobots: [
      {
        ...
        fit: 'strong',
        basis: 'deployment',
        evidenceDeploymentIds: ['agility-amazon-sumner', 'agility-gxo-flowery-branch'],
      ...
      },
      {
        ...
        evidenceSourceUrls: ['https://www.figure.ai/figure'],
  ...
  },
  {
    ...
    sources: [
      {
        ...
        checkedAt: '2026-05-30',
        reliability: 'official',
        note: 'Walker S2 の産業向け機能と24/7稼働対応の裏取り。',
      },
      {
    ...
    candidateRobots: [
      ...
      },
      {
        ...
        fit: 'watch',
        basis: 'market-signal',
        evidenceSourceUrls: ['https://www.tesla.com/optimus'],
    ...
    sources: [
      {
        ...
        reliability: 'official',
        note: 'TALOS の研究用途と Waterloo RoboHub 導入（data/deployments.ts の pal-talos-waterloo と同一出典）。',
      },
      {
    ...
    candidateRobots: [
      {
        ...
        fit: 'strong',
        basis: 'deployment',
        evidenceDeploymentIds: ['pal-talos-waterloo'],
    ...
    sources: [
      {
        ...
        checkedAt: '2026-06-17',
        reliability: 'official',
        note: 'R1 / R1 AIR の価格帯・運動性能・量産構成の裏取り。',
      },
      {
        title: 'Booster K1',
  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        reliability: 'official',
        note: 'Walker X のスマートサービス・HRI向け製品能力の裏取り。',
      },
    ],
    heroImage: {
      src: '',
    ...
    candidateRobots: [
      ...
      },
      {
        ...
        fit: 'possible',
        basis: 'product-capability',
        evidenceSourceUrls: ['https://www.ubtrobot.com/en/humanoid/products/walker-x'],
    ...
    candidateRobots: [
      {
        ...
        fit: 'strong',
        basis: 'deployment',
        evidenceDeploymentIds: ['sanctuary-canadian-tire-langley'],
  ...
  },
  {
    ...
    candidateRobots: [
      ...
      },
      {
        ...
        fit: 'watch',
        basis: 'product-capability',
        evidenceSourceUrls: ['https://fftai.com/'],
  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        checkedAt: '2026-06-01',
        reliability: 'official',
        note: 'Mercedes-Benz ベルリン工場での Apollo 実証（data/deployments.ts の apptronik-mercedes-berlin と同一出典）。',
      },
      {
        ...
        checkedAt: '2026-06-15',
        reliability: 'official',
        note: 'Mercedes-Benz ケチケメート工場での Apollo 実証（data/deployments.ts の apptronik-mercedes-kecskemet と同一出典）。',
      },
      {
        ...
        checkedAt: '2026-06-01',
        reliability: 'official',
        note: 'NIO 合肥工場での Walker S 実証（data/deployments.ts の ubtech-nio-hefei と同一出典）。',
      },
      {
        ...
        checkedAt: '2026-06-01',
        reliability: 'reported',
        note: 'Optimus の自社工場稼働に関する報道ベースの根拠（data/deployments.ts の tesla-optimus-fremont と同一出典）。',
      },
    ],
    heroImage: {
      src: '',
    ...
    candidateRobots: [
      {
        ...
        fit: 'strong',
        basis: 'deployment',
        evidenceDeploymentIds: ['apptronik-mercedes-berlin', 'apptronik-mercedes-kecskemet'],
      ...
      },
      {
        ...
        fit: 'strong',
        basis: 'deployment',
        evidenceDeploymentIds: ['ubtech-nio-hefei'],
      ...
      },
      {
        ...
        fit: 'strong',
        basis: 'deployment',
        evidenceDeploymentIds: ['tesla-optimus-fremont'],

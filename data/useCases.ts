...
export const useCases: UseCase[] = [
  ...
  },
  {
    ...
    reliability: 'reported',
    sources: [
      { title: 'Agility Robotics solutions', url: 'https://www.agilityrobotics.com/solutions', publisher: 'Agility Robotics', checkedAt: '2026-06-30', reliability: 'official' },
    ],
    maturityLevel: 'pilot-phase',
    buyerReadiness: 'requires-poc',
    environment: 'indoor-semi-controlled',
    ...
    candidateRobots: [
      { robotId: 'agility-digit', fit: 'possible', basis: 'official-use-case', evidenceSourceUrls: ['https://www.agilityrobotics.com/solutions'], reason: 'Agility Roboticsが物流センター向けソリューションとして公式に訴求。Amazon提携実績あり。' },
    ],
  },
  ...
  },
  {
    ...
    candidateRobots: [
      ...
      { robotId: 'figure-03', fit: 'possible', basis: 'official-use-case', evidenceSourceUrls: ['https://www.figure.ai/'], reason: 'Figure 03はFigure 02の後継として同様のAI学習プラットフォーム用途を継承。' },
      {
        robotId: 'pal-kangaroo',
        fit: 'possible',
        basis: 'official-use-case',
  ...
  },
  {
    ...
    candidateRobots: [
      { robotId: 'figure-03', fit: 'possible', basis: 'official-use-case', evidenceSourceUrls: ['https://www.figure.ai/'], reason: 'Figure 03が研究・試作開発向けにオープンなプラットフォームとして提供されている。' },
      {
        robotId: 'booster-t1',
        fit: 'possible',
        basis: 'official-use-case',

...
export const useCases: UseCase[] = [
  ...
  },
  {
    ...
    reliability: 'estimated',
    sources: [
      { title: '1X Technologies use cases', url: 'https://www.1x.tech/', publisher: '1X Technologies', checkedAt: '2026-06-30', reliability: 'official' },
    ],
    maturityLevel: 'pilot-phase',
    buyerReadiness: 'requires-poc',
    environment: 'indoor-semi-controlled',
    ...
    candidateRobots: [
      { robotId: 'onex-eve', fit: 'watch', basis: 'product-capability', evidenceSourceUrls: ['https://www.1x.tech/'], reason: '1X Technologiesが精密把持タスクへの対応能力を訴求しているが、農業用途での実証は確認できていない。' },
    ],
  },
  {
  ...
  },
  {
    ...
    candidateRobots: [
      { robotId: 'onex-neo', fit: 'possible', basis: 'official-use-case', evidenceSourceUrls: ['https://www.1x.tech/androids/neo'], reason: '1X Technologies NEO が施設内ゴミ回収・整理タスクを実証している。' },
    ],
  },
  {
  ...
  },
  {
    ...
    candidateRobots: [
      { robotId: 'onex-eve', fit: 'possible', basis: 'official-use-case', evidenceSourceUrls: ['https://www.1x.tech/'], reason: '1X TechnologiesのEVEが施設警備巡回ユースケースを訴求している。' },

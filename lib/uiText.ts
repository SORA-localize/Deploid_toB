export const uiText = {
  ...
  robots: {
    ...
    detailedSpecifications: '詳細仕様',
    intendedUses: '想定用途',
    usageExamples: '活用事例',
    relatedRobots: '関連ロボット',
    publicInfoMissing: '公開情報なし',
    specExplorerAria: '詳細仕様の分類',
    cardFacts: {
      useCase: '用途',
      size: 'サイズ',
      price: '価格',
  ...
  comparison: {
    ...
    emptyDescription: '左のメーカーメニューから追加できます。',
    emptyDescriptionMobile: '下のメーカーリストからロボットを選んで追加してください。',
    ...
    viewToggleAria: 'スペック表示の切替',
    specToggleLabel: 'スペック',
    toastSpecsOn: 'スペック表示',
    toastSpecsOff: 'サムネ表示',
    shareLink: 'この比較を共有',

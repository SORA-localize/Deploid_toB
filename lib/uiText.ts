export const uiText = {
  ...
  robots: {
    ...
    filteredAcrossRelease: '絞り込み中は販売中・開発中を横断して表示しています。',
    crossReleaseCountsAria: '絞り込み中のリリースステータス別件数',
  ...
  guides: {
    ...
    relatedInfo: '関連情報',
    consultation: '選定の相談',
    consultationDescription: 'このガイドの内容を踏まえて検討したい場合はご相談ください。',
  ...
  useCases: {
    ...
    seeGuideForDetail: (guideTitle: string) => `詳しい判断基準は「${guideTitle}」を参照 →`,
    deploymentSource: (publisher: string) => `出典：${publisher}`,
    overviewFields: {
      domain: '得意分野',
      maturity: '成熟度',
      buyerReadiness: '実務ラベル',
      environment: '環境',

export const uiText = {
  ...
  manufacturers: {
    ...
    lastUpdated: '最終更新',
    procurementLead: '国内窓口、調達条件、サポート、継続確認ポイントを分けて確認できます。',
    distributorMemo: '国内窓口',
    supportMemo: 'サポート',
    procurementMemo: '調達条件',
    vendorRiskMemo: '継続確認',
    noProcurementMemo: '公開情報から確認できる調達メモは準備中です。正式条件は公式窓口で確認してください。',
